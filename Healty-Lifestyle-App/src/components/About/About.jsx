    ...
    <div className="about-page">
      <div className="text">
        ...
        <p>
          ...
          consistent, manageable habits, not drastic overhauls. That’s why our
          app focuses on bite-sized challenges, personalized progress tracking,
          and positive reinforcement rather than guilt trips. Whether you’re
          swapping soda for sparkling water or aiming for your first 5K, we’re
          here to celebrate every victory, big or small. By blending expert
          insights with smart notifications and a supportive community, we want
          to help you build—and stick with—habits that last a lifetime.
        </p>
      </div>
      <img
